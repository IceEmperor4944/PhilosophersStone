...
@export var list = {
	...
	"lava" 		= [["fire","earth", "none", "none"], 	[0.6, 0.4, 0.0, 0.0], "res://Assets/Magical/spr_stroked_potion_testtube_red.png"],
	...
	"egg" 		= [["life","fire", "none", "none"], 	[0.8, 0.2, 0.0, 0.0], "res://Assets/Magical/spr_stroked_potion_testtube_cyan.png"],
	...
	"philosophersStone"	= [["sulfur","mercury", "salt", "bismuth"],	[0.3, 0.3, 0.3, 0.1], "res://Assets/Magical/spr_stroked_potion_testtube_cyan.png"],
